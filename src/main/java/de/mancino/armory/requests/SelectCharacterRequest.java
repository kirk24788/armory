...
public class SelectCharacterRequest extends ArmoryHomepageRequest {
    /**
     * Logger instance of this class.
     */
    private static final Logger LOG = LoggerFactory.getLogger(SelectCharacterRequest.class);

    private BasicNameValuePair[] selectCharacterParams;

    private String index;

    public SelectCharacterRequest(final String realmName, final String charName) {
        this(new ArmoryBaseUri(), realmName, charName);
    }

    public SelectCharacterRequest(ArmoryBaseUri armoryBaseUri, final String realmName, final String charName) {
    ...
    private String getCharacterIndex(final ArmoryBaseUri armoryBaseUri, final String realmName, final String charName) {
        final String encodedRealmName;
        final String encodedCharName;
        try {
            encodedRealmName = URLEncoder.encode(realmName, "UTF-8");
            encodedCharName = URLEncoder.encode(charName, "UTF-8");
