...
public final class HashSHA1
{
    ...
    /**
     * Update the hash engine with a subset of a byte[] array.
     * 
     * @param input Array to update the engine with
     * @param offset Index in "input"
     * @param len Length of the array subset
     */
    ...
    /**
     * Update the hash engine with a byte array.
     * @param input
     */
    ...
    {
		return ((abyte0[offset] & 0xff) << 24)
				+ ((abyte0[offset + 1] & 0xff) << 16)
				+ ((abyte0[offset + 2] & 0xff) << 8)
				+ (abyte0[offset + 3] & 0xff);
    }
